  ...
  return (
    <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
      ...
      <div className="mt-4">
        ...
        <p className="text-xs mt-2 text-gray-600 ">test2gmail.com</p>
...
Contact.getLayout = (page) => <Layouts title="Contact">{page}</Layouts>;

Contact.getInitialProps = async ({ req }) => {
  let res;
  if (!!req) {
    res = await axios.get("https://jsonplaceholder.typicode.com/users/4");
  } else {
    res = await axios.get("https://jsonplaceholder.typicode.com/users/5");
  }
